...
private:
    ...
    static const map<string, vector<string>> init_valid_syllable_dict();
    static const vector<string> init_valid_syllable_tokens();
...
public:
    ...
    static inline const map<string, vector<string>> valid_syllable_dict = init_valid_syllable_dict();
    static inline const vector<string> valid_syllable_tokens = init_valid_syllable_tokens();
};
} // namespace blitz
