...
#
# setup.tcl: Tcl script for re-creating project 'clocking_block_practice'
#
# Generated by Vivado on Fri May 13 13:33:56 +0800 2022
...
#
#    "D:/Projects/Practice/EE/SystemVerilog/clocking_block_practice/rtl/memory.v"
#    "D:/Projects/Practice/EE/SystemVerilog/clocking_block_practice/testbenches/clocking_block.sv"
#
#*****************************************************************************************
...
set _xil_proj_name_ "clocking_block_practice"
...
# Create project
create_project ${_xil_proj_name_} "./work" -part xc7z010iclg225-1L
...
set files [list \
 [file normalize "${origin_dir}/../rtl/memory.v"] \
]
...
set files [list \
 [file normalize "${origin_dir}/../testbenches/clocking_block.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../testbenches/clocking_block.sv"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z010iclg225-1L -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010iclg225-1L -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
